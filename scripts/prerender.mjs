...
const ROUTES = [
  ...
  { path: '/services/led-video-walls', title: 'LED Video Wall Hire Ireland | LED Screen Rental Dublin | EventSound', description: 'LED video wall hire and rental across Ireland. High-resolution Unilumin LED video walls for conferences, concerts, corporate events, and exhibitions. Mobile LED wall rental available.' },
  ...
  { path: '/services/staging-pipe-drape', title: 'Stage Hire Ireland | Portable Stage & Platform Rental | EventSound', description: 'Stage hire across Ireland. Premium GUIL stage platforms with steps, barriers, and wheelchair ramps. Indoor and outdoor stage solutions for conferences, concerts, and festivals.' },
