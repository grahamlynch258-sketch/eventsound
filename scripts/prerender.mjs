...
const ROUTES = [
  ...
  { path: '/services/led-video-walls', title: 'LED Video Wall Hire Ireland | LED Screen Rental Dublin | EventSound', description: 'LED screen hire across Ireland. High-resolution Unilumin LED video walls for conferences, concerts, corporate events, and exhibitions. Mobile LED screen hire available.' },
