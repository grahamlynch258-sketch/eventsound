...
const faqs = [
  ...
  { question: "How many wireless microphones can you provide?", answer: "We carry large-scale wireless systems that can support 30+ simultaneous channels, covering even the largest cast productions. Each performer gets their own body-worn transmitter with a DPA or Sennheiser headset microphone, and we bring spare units for every show." },
...
const serviceSections = [
  {
    ...
    copy: [
      ...
      "We supply Shure and Sennheiser wireless systems with body-worn transmitters and discreet headset microphones for each performer. Our sound engineers programme individual channel EQ, manage cue-by-cue level changes, and handle all wireless frequency coordination — so your cast and creative team can focus on the performance.",
