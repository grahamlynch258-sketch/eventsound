...
export function CTASection({
  ...
  // Default description includes SLA from config
  const defaultDescription = `Tell us your date, venue, and vision. We'll come back with a clear recommendation and a transparent quote — ${siteConfig.quoteResponseSLA}.`;
