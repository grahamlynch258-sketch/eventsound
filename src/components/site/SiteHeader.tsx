...
import { Menu, X, ChevronDown, HelpCircle, Star, Mail, Images, BookOpen, Monitor, Volume2, Lightbulb, Theater, Clapperboard, Video, Wifi, LayoutGrid, Presentation, Music } from "lucide-react";
